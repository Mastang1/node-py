...
def node_0x1d4c109ee10(context):
    # 配置时序 (ApiNodeSimDigitalPatternGeneratorIviConfiguretiming)
    raw_handle = _read_input_value(context, ('0x1d4bec52f60', 'handle'), '')
    ...
    _set_output_value(context, '0x1d4c109ee10', 'status', value_status)
    ...
    return 'flow_out'
def node_0x1d4beff78f0(context):
    ...
    if result_list is None:
        ...
        result_list = list(result_list)
    value_status = result_list[0] if len(result_list) > 0 else None
    _set_output_value(context, '0x1d4beff78f0', 'status', value_status)
    context['variables']['status'] = value_status
    context['variables']['load_pattern.status'] = value_status
    context['last_result'] = context['variables']['status']
    return 'flow_out'
def node_0x1d4beff5c10(context):
...
def node_0x1d4bec52f60(context):
    ...
    _set_output_value(context, '0x1d4bec52f60', 'handle', value_handle)
    ...
    _set_output_value(context, '0x1d4bec52f60', 'identity', value_identity)
    ...
    return 'flow_out'
def node_0x1d4c109ce00(context):
    ...
    _set_output_value(context, '0x1d4c109ce00', 'code', value_code)
    ...
    _set_output_value(context, '0x1d4c109ce00', 'message', value_message)
    ...
    return 'flow_out'
def node_0x1d4c109d9a0(context):
    ...
    _set_output_value(context, '0x1d4c109d9a0', 'value', unpacked_value)
    context['last_result'] = unpacked_value
    return 'flow_out'
def node_0x1d4c109cfe0(context):
    # 写回自检消息 (WriteVariableFromInputNode)
    input_value = _read_input_value(context, ('0x1d4c109d9a0', 'value'), '')
    context['variables']['dpg_self_test'] = input_value
    _set_output_value(context, '0x1d4c109cfe0', 'value', input_value)
    context['last_result'] = input_value
    return 'flow_out'
def node_0x1d4beff5a00(context):
    ...
    _set_output_value(context, '0x1d4beff5a00', 'running', value_running)
    ...
    _set_output_value(context, '0x1d4beff5a00', 'timing', value_timing)
    ...
    _set_output_value(context, '0x1d4beff5a00', 'pattern_loaded', value_pattern_loaded)
    ...
    return 'flow_out'
def node_0x1d4beed61e0(context):
    # 写回时序摘要 (WriteVariableFromInputNode)
    input_value = _read_input_value(context, ('0x1d4beff5a00', 'timing'), '')
    context['variables']['dpg_timing'] = input_value
    _set_output_value(context, '0x1d4beed61e0', 'value', input_value)
    context['last_result'] = input_value
    return 'flow_out'
def node_0x1d4beed4050(context):
    ...
    if result_list is None:
        ...
        result_list = list(result_list)
    value_status = result_list[0] if len(result_list) > 0 else None
    _set_output_value(context, '0x1d4beed4050', 'status', value_status)
    context['variables']['status'] = value_status
    context['variables']['stop_output.status'] = value_status
    context['last_result'] = context['variables']['status']
    return 'flow_out'
def node_0x1d4beed4e90(context):
    ...
    if result_list is None:
        ...
        result_list = list(result_list)
    value_status = result_list[0] if len(result_list) > 0 else None
    _set_output_value(context, '0x1d4beed4e90', 'status', value_status)
    context['variables']['status'] = value_status
    context['variables']['close_session.status'] = value_status
    context['last_result'] = context['variables']['status']
    return 'flow_out'
def node_0x1d4c109cf80(context):
    # 返回 (ReturnNode)
    context['return_value'] = context['variables'].get('dpg_timing')
    context['last_result'] = context['return_value']
    context['terminated'] = True
    return None
START_NODE_ID = '0x1d4bea4e120'
FLOW_LINKS = {'0x1d4c109ee10': {'flow_out': '0x1d4beff78f0'}, '0x1d4beff78f0': {'flow_out': '0x1d4beff5c10'}, '0x1d4beff5c10': {'flow_out': '0x1d4beff5a00'}, '0x1d4bea4e120': {'flow_out': '0x1d4bec52f60'}, '0x1d4bec52f60': {'flow_out': '0x1d4c109ce00'}, '0x1d4c109ce00': {'flow_out': '0x1d4c109d9a0'}, '0x1d4c109d9a0': {'flow_out': '0x1d4c109cfe0'}, '0x1d4c109cfe0': {'flow_out': '0x1d4c109ee10'}, '0x1d4beff5a00': {'flow_out': '0x1d4beed61e0'}, '0x1d4beed61e0': {'flow_out': '0x1d4beed4050'}, '0x1d4beed4050': {'flow_out': '0x1d4beed4e90'}, '0x1d4beed4e90': {'flow_out': '0x1d4c109cf80'}, '0x1d4c109cf80': {}}
UNREACHABLE_NODES = []
NODE_NAMES = {
    '0x1d4c109ee10': '配置时序',
    '0x1d4beff78f0': '加载模式',
    '0x1d4beff5c10': '开始输出',
    '0x1d4bea4e120': '开始',
    '0x1d4bec52f60': '初始化数字模式发生器',
    '0x1d4c109ce00': '数字模式自检',
    '0x1d4c109d9a0': '拆包自检消息',
    '0x1d4c109cfe0': '写回自检消息',
    '0x1d4beff5a00': '查询状态',
    '0x1d4beed61e0': '写回时序摘要',
    '0x1d4beed4050': '停止输出',
    '0x1d4beed4e90': '关闭数字模式会话',
    '0x1d4c109cf80': '返回',
}
...
def _set_output_value(context, node_id, key, value):
    ...
    return value
NODE_DISPATCH = {
    '0x1d4c109ee10': node_0x1d4c109ee10,
    '0x1d4beff78f0': node_0x1d4beff78f0,
    '0x1d4beff5c10': node_0x1d4beff5c10,
    '0x1d4bea4e120': node_0x1d4bea4e120,
    '0x1d4bec52f60': node_0x1d4bec52f60,
    '0x1d4c109ce00': node_0x1d4c109ce00,
    '0x1d4c109d9a0': node_0x1d4c109d9a0,
    '0x1d4c109cfe0': node_0x1d4c109cfe0,
    '0x1d4beff5a00': node_0x1d4beff5a00,
    '0x1d4beed61e0': node_0x1d4beed61e0,
    '0x1d4beed4050': node_0x1d4beed4050,
    '0x1d4beed4e90': node_0x1d4beed4e90,
    '0x1d4c109cf80': node_0x1d4c109cf80,
}
