...
TEXTS = {
    ...
    "help_html_flow": {
        LANG_ZH: (
            ...
            "<li><b>导出 Python</b>：生成与 GUI 同一语义的 <code>instrument_flow_body(context)</code> 函数体（可嵌入测试/应用），不含独立可执行入口。</li>"
        ...
        LANG_EN: (
            ...
            "<li><b>Export Python</b>: emits an <code>instrument_flow_body(context)</code> function body (embed in tests/apps), not a standalone executable script.</li>"
